    ...
    items: [
      {
        ...
        items: [
          ...
          {
            text: 'v0.8 Reference',
            link: '/contributing/extensions/reference-0.8/',
            collapsed: true,
            items: [
              {
                text: 'Functions',
                link: '/contributing/extensions/reference-0.8/functions',
              },
              {
                text: 'Models',
                link: '/contributing/extensions/reference-0.8/models',
              },
              {
                text: 'Metadata Parameter',
                link: '/contributing/extensions/reference-0.8/metadata',
              },
            ],
          },
          {
            text: 'v0.7 Reference',
            link: '/contributing/extensions/reference-0.7/',
            collapsed: true,
            items: [
              {
                text: 'Migrate to v0.8',
                link: '/contributing/extensions/reference-0.7/migrate-to-0.8',
              },
              {
                text: 'Functions',
                link: '/contributing/extensions/reference-0.7/functions',
              },
              {
                text: 'Models',
                link: '/contributing/extensions/reference-0.7/models',
              },
              {
                text: 'Metadata Parameter',
                link: '/contributing/extensions/reference-0.7/metadata',
              },
            ],
          },
        ],
