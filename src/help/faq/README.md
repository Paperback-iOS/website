...
### How do I enable Hentai <el-tag size="mini" type="warning">depreciated</el-tag>
...
### Manga are not showing up in my library after I follow them? <el-tag size="mini" type="warning">depreciated</el-tag>
...
Sometimes, usually after the source makes modifications to its website, a source can stop working in the app.
Troubleshooting steps:

 * A source may require a <a href="/help/faq/#bypass-cloudflare-protection">bypass CloudFlare</a> process
 * Check the issue was not reported: known source issues are listed in our Discord #source-updates channel
 * Make sure your source and application are up to date
 * Check the source in webview, if it does not work, there is nothing Paperback can do as the source relies on the website to get contents
...
### The app crash when I try to make a backup
Go to **Settings** and press "**Clear orphaned chapters**"
